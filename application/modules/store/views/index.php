        ...
        if (!empty($store)) {
          ...
          foreach ($store as $row): 
            ...
            <tr>
              ...
              <td>
                <a href="#" class="btn btn-info btn-xs btnEdit mb-1" data-toggle="modal" data-target="#add" data-id="<?php echo $row->store_id ?>" data-name="<?php echo $row->store_name ?>"><i class="fas fa-edit"></i> Ubah</a>
              </td>
            </tr>
          <?php endforeach; 
        } else {
