                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="cuti_start" id="cuti_start" class="form-control datepicker" autocomplete="off">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="">Tanggal Akhir Cuti</label>
                                <input type="text" name="cuti_end" id="cuti_end" class="form-control datepicker" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="">Alasan Cuti</label>
                        <textarea name="cuti_desc" id="cuti_desc" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <button type="submit" class="btn btn-success btn-block mt-3">Simpan</button>
                    <a class="btn btn-secondary btn-block" href="<?php echo site_url('cuti') ?>">Batal</a>
                </div>
            </div>
        </form>
    </div>
